...
var format_Police_Facilities_1 = new ol.format.GeoJSON();
var features_Police_Facilities_1 = format_Police_Facilities_1.readFeatures(json_Police_Facilities_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Police_Facilities_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Police_Facilities_1.addFeatures(features_Police_Facilities_1);
var lyr_Police_Facilities_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Police_Facilities_1, 
                style: style_Police_Facilities_1,
                popuplayertitle: "Police_Facilities",
                interactive: true,
                title: '<img src="styles/legend/Police_Facilities_1.png" /> Police_Facilities'
            });
var format_HealthcareFacilities_2 = new ol.format.GeoJSON();
var features_HealthcareFacilities_2 = format_HealthcareFacilities_2.readFeatures(json_HealthcareFacilities_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_HealthcareFacilities_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_HealthcareFacilities_2.addFeatures(features_HealthcareFacilities_2);
var lyr_HealthcareFacilities_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_HealthcareFacilities_2, 
                style: style_HealthcareFacilities_2,
                popuplayertitle: "Healthcare Facilities",
                interactive: true,
                title: '<img src="styles/legend/HealthcareFacilities_2.png" /> Healthcare Facilities'
            });
