...
map.getView().fit([10778932.710124, -5547049.878133, 17396453.423719, -1116064.164138], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Climate Adaptation for WA Public Buildings</h2>';
        return titleElement;
    })(),
